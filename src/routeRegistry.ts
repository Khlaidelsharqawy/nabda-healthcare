...
export const screenRoutes: ScreenRoute[] = [
  ...
  screen('/signup', 'Patient registration', 'auth', 'aegishealth_unified_secure_login_role_based_dispatch_login'),
  screen('/request-access', 'Healthcare provider access request', 'auth', 'aegishealth_unified_secure_login_role_based_dispatch_login'),
  ...
  screen('/patient/chat', 'AI Health Companion Chat', 'patient'),
  screen('/doctor/profile', 'Doctor Profile and Settings', 'doctor'),
  screen('/assistant/profile', 'Assistant Profile and Settings', 'assistant'),
  screen('/admin/profile', 'Platform Administrator Profile', 'admin'),
];
